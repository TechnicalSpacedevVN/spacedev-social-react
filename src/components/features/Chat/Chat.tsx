      ...
      <div className=" h-14 flex items-center gap-2 p-2 border-0 border-b border-solid border-gray-300 dark:border-gray-700">
        <div className="w-9 h-9 rounded-xl overflow-hidden ">
          <img
            ...
            src="https://unsplash.it/50/50?t=98"
          />
        </div>
        <div className="flex flex-col">
          <div className="font-semibold text-gray-700 text-xs dark:text-white">
            Grace Norton
          </div>
          ...
          <React.Fragment key={i}>
            <div className="flex gap-2">
              ...
              <div className="flex flex-1 flex-col gap-1">
                ...
                <p className="max-w-[calc(100%-100px)] text-sm text-gray-700 px-2 py-0.5 rounded-lg bg-gray-200 w-fit dark:bg-slate-700 dark:text-white">
                  art slave bark direct face danger drew test bell you paragraph
                  sheet third limited ground tone captured sing greatly well
                  heading audience hair steel
                </p>
              </div>
            </div>
            <div className="flex gap-2 ">
