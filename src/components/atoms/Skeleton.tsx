...
export const Skeleton: Atom<SkeletonProp> = React.memo(
  ({ width, height, circle, text, className, avatar }) => {
    if (avatar) {
      return (
        <svg
    ...
    let _className =
      'bg-[#eee] bg-[length:200%_100%] bg-gradient-to-r from-[#ececec] via-[#ffffff] to-[#ececec] animate-shine w-full block dark:from-slate-600 dark:via-slate-500  dark:to-slate-600';
